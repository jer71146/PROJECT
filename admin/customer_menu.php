    ...
    <div class="row">
      ...
      <div class="col-xs-12">
        ...
        <ul class="nav nav-pills">
        	<li role="presentation" <?php echo ($index == 0)?'class="active"':'';?>><a href="customer_index.php"><text>首頁</text></a></li>
					<li role="presentation" <?php echo ($index == 1)?'class="active"':'';?>><a href="shopping_list.php"><text>購物車</text></a></li>
          <li role="presentation" <?php echo ($index == 2)?'class="active"':'';?>><a href="customer_manage.php"><text>會員管理</text></a></li>
