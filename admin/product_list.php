						...
						<td class = "left-part" valign="top">
								<div class="btn-group">
									<div class="btn-group-vertical">
										分類
										<button type="button" class="btn btn-secondary"><a href="http://localhost/ZZZ/admin/product_list.php?c=0" <?php echo ($index == 0)?'class="active"':'';?>> 全部  </a></button>
										<br>
										<button type="button" class="btn btn-secondary"><a href="http://localhost/ZZZ/admin/product_list.php?c=1" <?php echo ($index == 1)?'class="active"':'';?>> 吃  </a></button>
										<button type="button" class="btn btn-secondary"><a href="http://localhost/ZZZ/admin/product_list.php?c=2" <?php echo ($index == 2)?'class="active"':'';?>> 喝  </a></button>
										<br>
										<button type="button" class="btn btn-secondary"><a href="http://localhost/ZZZ/admin/product_list.php?c=3" <?php echo ($index == 3)?'class="active"':'';?>> 冷  </a></button>
										<button type="button" class="btn btn-secondary"><a href="http://localhost/ZZZ/admin/product_list.php?c=4" <?php echo ($index == 4)?'class="active"':'';?>> 熱  </a></button>
